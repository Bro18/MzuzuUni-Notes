"""
Django settings for mzuzu_notes project.
...
SECRET_KEY = 'django-insecure-!a=o)4750qu33%_=i@us93(mlo4+^fwuz2u+qj$_d(^v7arku1'
...
WSGI_APPLICATION = 'mzuzu_notes.wsgi.application'
